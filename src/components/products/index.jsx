    ...
    return (
        <section className="products" id="products">
            <article className="products-item">
                <img src={IlluSEO} alt="Illustration SEO" aria-label="Illustration SEO"></img>
            ...
            <article className="products-item">
                <img src={IlluDEV} alt="Illustration Développement" aria-label="Illustration Développement"></img>
                <div className="products-item_desc flex-between">
            ...
            <article className="products-item">
                <img src={IlluUPLOAD} alt="Illustration Mise en Ligne" aria-label="Illustration Mise en Ligne"></img>
                <div className="products-item_desc flex-between">
